...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, EN_4988_Pin|RELAY_Pin|VALVE_1_Pin|VALVE_2_Pin
                          |FAN_Pin|PUMP_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = EN_4988_Pin|STEP_Pin|DIR_Pin|RELAY_Pin
